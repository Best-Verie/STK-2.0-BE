...
public class SwaggerApiDoc extends WebMvcConfigurationSupport {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).directModelSubstitute(LocalDate.class, Date.class)
                ...
                }).select().apis(RequestHandlerSelectors.basePackage("rw.gov.sacco.stockmis.v1.controllers"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("SACCO Stock Management API").description("APIs Documentation")
                .termsOfServiceUrl("https://github.com/SauveJeanLuc/sacco-stock-backend")
                .version("1.0").build();
    }
}
